...
class PostsController {
	...
	public function get_item( WP_REST_Request $request ) {
		...
		if ( empty( $item ) ) {
			return new WP_Error(
				'not_found',
				__( 'Item not found', 'codesoup-woo-boxnow' ),
				array( 'status' => 404 )
			);
		}
	...
	public function create_item( WP_REST_Request $request ) {
		...
		return new WP_REST_Response(
			array(
				'message' => __( 'Created', 'codesoup-woo-boxnow' ),
			),
			201
		);
	}
...
if ( $id <= 0 ) {
	return new WP_Error(
		'invalid_id',
		__( 'Invalid ID', 'codesoup-woo-boxnow' ),
		array( 'status' => 400 )
	);
}
...
if ( ! $item ) {
	return new WP_Error(
		'not_found',
		__( 'Not found', 'codesoup-woo-boxnow' ),
		array( 'status' => 404 )
	);
}
```
...
use CodeSoup\BoxNow\Api\PostsController;
...
```bash
# GET
curl https://site.com/wp-json/csbxwoo/v1/posts

# POST
curl -X POST https://site.com/wp-json/csbxwoo/v1/posts \
...
```javascript
fetch( '/wp-json/csbxwoo/v1/posts' )
...
- Use namespace format: `csbxwoo/v1`
