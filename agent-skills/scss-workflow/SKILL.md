...
```css
.csbxwoo__card { padding: 16px; }
.csbxwoo__card--featured { border: 2px solid #0073aa; }
.csbxwoo__card__title { font-size: 24px; margin-bottom: 8px; }
.csbxwoo__card__content { color: #23282d; }
```
